...
본 위치기반 서비스 이용약관(이하 ‘본 약관’이라 합니다)은 Beesknees(이하 "회사"라 합니다)가 운영, 제공하는 서비스 플랫폼(행아웃(hangout) 웹, 모바일 웹 · 앱 포함, 이하 ‘플랫폼’이라 합니다)을 통한 위치기반서비스(이하 “서비스”)를 이용함에 있어 회사와 이용자 및 개인위치정보주체의 권리, 의무 및 책임사항에 따른 이용조건 및 절차 등 기본적인 내용을 규정함을 목적으로 합니다.
...
- 상호: Beesknees
- 주소: 20-9, Nambusunhwan-ro 240-gil, Gwanak-gu, Seoul, Republic of Korea
- 이메일 주소: roland.blain@gmail.com
