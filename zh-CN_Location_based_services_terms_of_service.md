...
本《基于位置服务的使用条款》（以下简称“条款”）旨在规定Beesknees（以下简称“公司”）与用户及个人（其位置信息受到收集）之间的权利、义务和责任的基本内容，涉及通过服务平台（以下简称“平台”）提供的基于位置的服务（以下简称“服务”），包括Hangout Web、Mobile Web和应用程序。
