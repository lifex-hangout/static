...
本サービス利用規約（以下、「本規約」といいます）は、Beesknees（以下、「会社」といいます）が提供するハングアウト（hangout）サービスおよび関連サービス（以下、「本サービス」といいます）の利用に関する会社と会員との権利・義務、責任事項およびその他必要な事項を定めることにより、相互間の理解関係を合理的に調整し、それに対応するスムーズなサービスシステムの運営および維持ができるようにすることを目的とします。
