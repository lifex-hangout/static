...
本《基於位置服務的使用條款》（以下簡稱“條款”）旨在規定Beesknees（以下簡稱“公司”）與用戶及個人（其位置信息受到收集）之間的權利、義務和責任的基本內容，涉及通過服務平臺（以下簡稱“平臺”）提供的基於位置的服務（以下簡稱“服務”），包括Hangout Web、Mobile Web和應用程序。
